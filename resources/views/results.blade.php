...
<div class="main-content container-fluid">
                ...
                <div class="row">
                    <table id="table2" class="table table-striped table-hover table-fw-widget">
                        ...
                        @foreach ($flr as $key)
                            ...
                            <td class="center">A{{$key['fuzzification']}}</td>
                            @if (is_null($key['orde']))
                                <td class="center">-</td>
                            @else
                                <td class="center">
                ...
                <div class="row">
                    <table id="table5" class="table table-striped table-hover table-fw-widget">
                        ...
                        <tbody>
                            ...
                            $i=1;
                            @endphp
                            @foreach ($defuzzification_chen as $key)
                            <tr>
                                <td class="center">{{$i}}</td>
                                <td class="center">
                                    @foreach ($key['relation'] as $key2)
                                ...
                                <td class="center">{{$key['prediction']}}</td>
                            </tr>
                            @php
                                $i++;
                            @endphp
                ...
                <div class="row">
                    <table id="table6" class="table table-striped table-hover table-fw-widget">
                        ...
                        @php
                            $i=1;
                        @endphp
                        @foreach ($defuzzification_lee as $key)
                            <tr>
                            <td class="center">{{$i}}</td>
                                <td class="center">
                                @foreach ($key['relation'] as $key2)
                ...
                <div class="row">
                    <table id="table7" class="table table-striped table-hover table-fw-widget">
                        ...
                        @php
                            $i=1;
                        @endphp
                        @foreach ($chen_prediction as $key)
                            <tr>
                            <td class="center">{{$i}}</td>
    ...
    <!-- Hasil Perbandingan Prediksi Chen vs Lee -->
    <div class="col-xs-12">
        <div class="panel panel-default">
                        ...
                        <tbody>
                            ...
                            @foreach ($chen_prediction as $key)
                                ...
                                <td class="center">A{{$key['fuzzification']}}</td>
                                    ...
                                    @if (!is_null($key['orde']))
                                    <td class="center">{{$lee_prediction[$i-1]['prediction']}}</td>
                                    @else
                                    <td class="center">-</td>
                                    @endif
                                </tr>
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
        <div class="panel-heading panel-heading-divider">Grafik Perbandingan antara Data Asli dengan Hasil Perhitungan Model Chen dan Model Lee<span class="panel-subtitle"></span></div>
            <div class="panel-body">
    ...
    var config = {
        ...
        data: {
            ...
            datasets: [{
                        ...
                        data: [@foreach ($dataset as $key){{(float)($key->data)}}, @endforeach],
                        fill: false,
                       },
                       {
                        label: 'Model Chen',
